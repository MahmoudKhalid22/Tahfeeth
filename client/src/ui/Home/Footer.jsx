...
function Footer() {
  return (
    <footer className="h-60 mt-36  w-full bg-[#9F8565] overflow-x-hidden md:mb-0 mb-[11.5rem]">
      ...
      <div className="bg-[#8A7A5F] shadow-[0_-2px_5.6px_1px_rgba(0,0,0,0.25)] text-[#ececec] flex flex-wrap text-center items-center justify-center absolute top-full w-full left-0 gap-1 px-8 sm:px-1 py-2">
