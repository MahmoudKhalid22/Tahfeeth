...
function Footer() {
  return (
    <footer className="h-60 mt-36 w-full bg-[#9F8565] overflow-x-hidden ">
      ...
      <div className="bg-[#8A7A5F] shadow-[0_-2px_5.6px_1px_rgba(0,0,0,0.25)] text-[#ececec] flex flex-wrap text-center items-center justify-center absolute bottom-0 w-[80%]  left-0 gap-1 px-8 sm:px-1 py-2">
